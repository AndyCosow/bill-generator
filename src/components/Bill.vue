    ...
    <div class="main">
      ...
      <div class="w-300">
        <div v-if="bill.date[1]" class="d-flex space-btw">
          <span class="m-0 d-flex items-center text-hover" @click="reverseValue('date')">{{ bill.date[0] }}</span>
        </div>
          ...
          <tr>
            <th v-for="(item, index) in bill.table.header" :key="index">
              <div v-if="bill.table.header[index][1]" class="d-flex space-btw items-center p-5">
                <div class="text-hover" @click="reverseValueDouble('table', 'header', index)">{{ item[0] }}</div>
            ...
            <td v-for="(itemSecond, indexTwo) in item" :key="indexTwo" class="p-5">
              <div class="d-flex space-btw" v-if="bill.table.content[index][indexTwo][1]">
                <div class="d-flex items-center">
                  ...
                  <span class="ml-10 text-hover" @click="reverseValueDouble('table', 'content', index, indexTwo)">{{
                    itemSecond[0]
                  }}</span>
                </div>
              </div>
      ...
      <div class="mt-50 ml-10">
        ...
        <div v-if="bill.showNotes">
          <div class="mb-30 text-hover w-300" @click="reverseNotes('title', 'notesTitle')" v-if="bill.notes.title[1]">
            {{ bill.notes.title[0] }}
          </div>
          ...
          <div class="mb-30 text-hover" @click="reverseNotes('value', 'notesValue')" v-if="bill.notes.value[1]">
            {{ bill.notes.value[0] }}
          </div>
      ...
      <div class="mt-50 ml-10">
        ...
        <div class="d-flex space-btw" v-if="bill.showSignatures">
          <div>
            <div class="mb-30 text-hover" @click="reverseProps('seller', 'propSeller')" v-if="bill.props.seller[1]">
              {{ bill.props.seller[0] }}
            </div>
            ...
            <div class="mb-30">
              <div class="d-flex space-btw" v-if="bill.signatures.seller[1]">
                <span class="text-hover" @click="reverseSignatures(true)">{{ bill.signatures.seller[0] }}</span>
              </div>
          ...
          <div>
            <div class="mb-30 text-hover" @click="reverseProps('buyer', 'propsBuyer')" v-if="bill.props.buyer[1]">
              {{ bill.props.buyer[0] }}
            </div>
            ...
            <div class="mb-30">
              <div class="d-flex space-btw" v-if="bill.signatures.buyer[1]">
                <span class="text-hover" @click="reverseSignatures(false)">{{ bill.signatures.buyer[0] }}</span>
              </div>
